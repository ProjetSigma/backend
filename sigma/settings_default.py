...
INSTALLED_APPS = (
    ...
    'sigma_publications.apps.SigmaPublicationsConfig',
)
...
NOSE_ARGS = ['--nocapture', '--nologcapture', '--with-coverage', '--cover-package=sigma,sigma_core,sigma_files,sigma_publications', ] # To display debug during testing
